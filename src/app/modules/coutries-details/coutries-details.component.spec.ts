...
describe("CoutriesDetailsComponent", () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: ActivatedRoute, useValue: fakeRouteParams },
        { provide: CoutriesService, useValue: mockCoutriesService },
  ...
  describe("Coutry details template", () => {
    it("should show coutryDetailWrapper with data provided in coutryDetails$", () => {
      const coutryDetailWrapper = fixture.debugElement.query(
        By.css(".coutry-details__wrapper")
      );
      const flagImage = fixture.debugElement.query(
        By.css('[data-test="flag-image"]')
      );
      const countryName = fixture.debugElement.query(
        By.css('[data-test="coutry-name"]')
      );
      const countryNativeName = fixture.debugElement.query(
        By.css('[data-test="coutry-native-name"]')
      );
      const countryPopulation = fixture.debugElement.query(
        By.css('[data-test="coutry-population"]')
      );
      const coutryRegion = fixture.debugElement.query(
        By.css('[data-test="coutry-region"]')
      );
      const countrySubRegion = fixture.debugElement.query(
        By.css('[data-test="coutry-sub-region"]')
      );
      const countryCapital = fixture.debugElement.query(
        By.css('[data-test="coutry-capital"]')
      );
      const countryTopDomain = fixture.debugElement.query(
        By.css('[data-test="coutry-top-domain"]')
      );
      const countryCurrencies = fixture.debugElement.queryAll(
        By.css('[data-test="coutry-currency"]')
      );
      const countryLanguages = fixture.debugElement.queryAll(
        By.css('[data-test="coutry-language"]')
      );
      const countryBorders = fixture.debugElement.queryAll(
        By.css('[data-test="coutry-border"]')
      );
      ...
      expect(countrySubRegion.nativeElement.innerHTML).toContain(
        "test-sub-region"
      );
      ...
      expect(countryCurrencies[0].nativeElement.innerHTML).toContain(
        "test-currience"
      );
      expect(countryCurrencies[1].nativeElement.innerHTML).toContain(
        "test2-currience"
      );
    ...
    it("should show message when coutry has no borders", () => {
      ...
      const noBorders = fixture.debugElement.query(
        By.css('[data-test="no-borders"]')
      );

      expect(countryBorders).toHaveLength(0);
      expect(noBorders.nativeElement.innerHTML).toContain(
        "This Coutry has no border coutries"
      );
    });
    ...
    it("should return button click call returnToList() method", fakeAsync(() => {
      ...
      const returnButton = fixture.debugElement.nativeElement.querySelector(
